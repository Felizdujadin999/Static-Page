import '../style/AffiliateMarketing.css';
...
import picture5 from '../asset/images/pic6.jpeg';
import picture6 from '../asset/images/pic7.jpeg';
import picture7 from '../asset/images/pic8.jpeg';
    ...
    return (
        <div className="section_main">
            ...
            <div className="secondwriteup">
                ...
                <img className="herImage" src={picture} alt="pic" />
            ...
            <p className="underline_">See what my students are saying about me and the results they are getting...</p> <br /><br />

            <div className='imgSection1'>
                <img src={picture5} alt="pic" />
                <img src={picture6} alt="pic" />
            </div>

            <div className='imgSection2'>
                <img src={picture7} alt="pic" />
            </div>
            
            <span className="thickner"><p>All of them were able to achieve these because of my exclusive Mentorship and Training</p></span>
            <p>If you want to know more about these business model and how you can get started, What are you waiting for, All you have to do is to..</p>
            <span className="thickner">CLICK THE BUTTON BELOW TO GET ACCESS RIGHT NOW!!!!!</span>
